...
class CityLookupTest {
	public static void main(String[] args) {
		// Location l1 = GeoIP.getLocation_("131.254.209.10");
		// Country c1 = cl.getCountry("131.254.209.10");
		// System.out.println(l1.toString());
		// System.out.println(c1.toString());

		// Location l1bis = clbis.getLocation("131.254.209.10");
		// Country c1bis = GeoIP.getCountry_("131.254.209.10");
		// System.out.println(l1bis.toString());
		// System.out.println(c1bis.toString());

		System.out.println(GeoIP.getCountry_("131.254.153.211"));
		System.out.println(GeoIP.getLocation_("131.254.153.211"));
