...
public class LookupService {
	...
	private static LookupService COUNTRY_LOOKUPSERVICE = null;
	private static LookupService LOCATION_LOOKUPSERVICE = null;

	static LookupService getLookupService(String dbName) {
		LookupService lookupService = null;
		try {
			InputStream countryDBGZStream = LookupService.class.getResourceAsStream("/" + dbName);
			...
			lookupService = new LookupService(bos.toByteArray());
		} catch (Exception e) {
	...
	static LookupService getCountryLookupService() {
	...
	static LookupService getLocationLookupService() {
	 ...
	 */
	LookupService(byte[] dbbuffer) throws IOException {
